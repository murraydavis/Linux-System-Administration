...
%\input{langdefs/bash} % messed up my commentstyle color
...
\date{}
\maketitle
\input{content/title_page_1} % downloaded template, note we do not have to specify '.tex' ending.
...
\input{content/ch_handy}
\input{content/ch_program}
\input{content/ch_manuals}
\input{content/ch_profiles}
\input{content/ch_vi}
\input{content/ch_find}
\input{content/ch_setuid}
\input{content/ch_acl}
\input{content/ch_file_tricks}
\input{content/ch_users_groups}
\input{content/ch_processes}
\input{content/ch_dnuf}
\input{content/ch_compression}
\input{content/ch_network}
\input{content/ch_selinux}
\input{content/ch_kernelservices}
\input{content/ch_workingwithdrives}
\input{content/ch_solutions}
\listoftodos
\listoffigures
\listoftables
\printindex
